...
export default function LoginDriver() {
  ...
  const LoginAuth = async (e) => {
    try {
      ...
      localStorage.setItem("namaDriver", response.data.data.name);
      localStorage.setItem("nokenderaan", response.data.data.noKenderaan);
      localStorage.setItem("imageDriver", response.data.data.image);
      localStorage.setItem("phoneDriver", response.data.data.phone);
