    ...
    <div className="flex flex-wrap pb-10">
      <div className="w-full xl:w-1/2 mb-12 xl:mb-0 px-4 mt-20 pl-16">
        ...
        <div className="flex mb-5">
          <div
            className={`py-3 px-20 text-white w-fit rounded-2xl mt-6 border-green-20 z-5 ${
              !show ? "bg-white text-green-50" : "bg-green-20"
            }`}
          ...
          <div
            className={`py-3 px-20 text-white w-fit rounded-2xl mt-6 border-green-20 z-5 ${
              !show ? "bg-green-20" : "bg-white text-green-50"
            }`}
            onClick={() => setshow(!show)}
          >
            Pickup
